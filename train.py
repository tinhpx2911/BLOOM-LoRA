...
class Trainer:
    ...
    def set_mixed_precision_context(self, mixed_precision_dtype):
        ...
        if mixed_precision_dtype is None:
            ...
            self.gradscaler = torch.amp.GradScaler() ### YOUR CODE HERE ###
...
def load_pretrained_model(local_rank, model_path: str = ""):
    ...
    model = transformers.AutoModelForCausalLM.from_pretrained(model_path, dtype=torch.float16) ### YOUR CODE HERE ###
